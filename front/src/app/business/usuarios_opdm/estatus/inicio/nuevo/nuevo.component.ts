...
export default class NuevoComponent {
  ...
  constructor(private router: Router, private _formBuilder: FormBuilder, private _estatususuarios_opdm_Service : estatususuarios_opdmService,private toastr: ToastrService,private _errorService:ErrorService) {
  ...
  saveParams(){
    this.loading = true;
    const estatus  : Nuevoestatususuarios_opdm ={
      id_usuario   : this.id_usuario,
      descripcion  : this.descripcion,
      activo : 1
    }
    this._estatususuarios_opdm_Service.newestatususuarios_opdm(estatus).subscribe({
      next: (v) => {
