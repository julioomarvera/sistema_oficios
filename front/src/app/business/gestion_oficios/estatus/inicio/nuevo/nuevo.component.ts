...
export default class NuevoComponent {
  ...
  constructor(private router: Router, private _formBuilder: FormBuilder, private _estatusgestion_oficios_Service : estatusgestion_oficiosService,private toastr: ToastrService,private _errorService:ErrorService) {
  ...
  saveParams(){
    this.loading = true;
    const estatus  : Nuevoestatusgestion_oficios ={
      id_usuario   : this.id_usuario,
      descripcion  : this.descripcion,
      activo : 1
    }
    this._estatusgestion_oficios_Service.newestatusgestion_oficios(estatus).subscribe({
      next: (v) => {
